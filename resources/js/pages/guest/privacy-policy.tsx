...
export default function PrivacyPolicy() {
    return (
        <AppLayout>
            ...
            <main className="min-h-screen px-6 py-16 text-white md:px-12 lg:px-24">
                <div className="mx-auto max-w-4xl">
                    ...
                    {/* Card */}
                    <div className="relative rounded-2xl border border-fuchsia-900/50 bg-[#0d0818]/80 p-8 shadow-[0_0_40px_-10px_rgba(168,85,247,0.25)] md:p-12">
                        <div className="space-y-8 text-[15px] leading-relaxed text-slate-300">
                            ...
                            <Section title="Interpretation and Definitions">
                                ...
                                <DefList
                                    items={[
                                        ...
                                        [
                                            'Company',
                                            '(referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to INCEPTION',
                                        ],
                                        [
                                            'Cookies',
                                        ...
                                        [
                                            'Website',
                                            'refers to INCEPTION, accessible from https://INCEPTION.com',
                                        ],
                                        [
                                            'You',
                            ...
                            <Section title="Collecting and Using Your Personal Data">
                                ...
                                <p>
                                    ...
                                    You use, Your mobile device unique ID, the
                                ...
                                <p>
                                    ...
                                    or when You access the Service by or through
                                    a mobile device.
                                </p>
                                ...
                                <p>
                                    ...
                                    and log in to use the Service through the
                                    following Third-party Social Media Services:
                                </p>
                                <BulletList items={['Google']} />
                                <p>
                                ...
                                <p>
                                    ...
                                    use and your choices regarding cookies,
                                    please visit our Cookies Policy or the
                            ...
                            <Section title="Delete Your Personal Data">
                                ...
                                <p>
                                    ...
                                    also contact Us to request access to,
                            ...
                            <Section title="Children's Privacy">
                                <p>
                                    ...
                                    anyone under the age of 13 without
                        ...
                        <div className="mt-12 flex flex-col justify-between gap-2 border-t border-fuchsia-900/40 pt-6 sm:flex-row">
...
function Section({
    ...
    return (
        <section>
            <h2 className="mb-4 flex items-center gap-3 text-xl font-bold tracking-tight text-white md:text-2xl">
                {title}
            </h2>
...
function SubHeading({ children }: { children: React.ReactNode }) {
    return (
        <h3 className="mt-6 mb-2 text-sm font-semibold tracking-wide text-fuchsia-300 uppercase">
            {children}
        </h3>
    );
}
        ...
        <ul className="space-y-2">
            {items.map((item, i) => (
                <li key={i} className="flex items-center gap-3">
                    <PlayIcon className="shrink-0 text-amber-400"></PlayIcon>
                    <span>{item}</span>
                </li>
            ))}
        </ul>
    ...
    return (
        <div className="mt-2 space-y-3">
            {items.map(([term, def], i) => (
                ...
                >
                    <span className="shrink-0 font-semibold text-white sm:w-44">
                        {term}
                    </span>
                    <span>{def}</span>
                </div>
...
function CookieCard({
    ...
    return (
        <div className="my-4 rounded-xl border border-fuchsia-900/40 bg-fuchsia-950/10 p-5">
            ...
            <p className="text-slate-300">{purpose}</p>
        </div>
    );
}
