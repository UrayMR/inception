...
<head>
  ...
  <!--[if mso]>
	...
	<![endif]-->
  <title>INCEPTION 2026 - Reset Kata Sandi</title>
  <style>
...
<body
  ...
  <div style="display:none; max-height:0; overflow:hidden; mso-hide:all; font-size:1px; line-height:1px; color:#0c0214;">
    Halo {{ $user->name ?? 'Pengguna' }}, Anda telah meminta atur ulang kata sandi untuk akun INCEPTION 2026 Anda.
  </div>
        ...
        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#0f051d"
          ...
          <tr>
            <td align="center" style="padding: 0 25px 25px 25px;">
              <h1 class="hero-title"
                ...
                RESET KATA SANDI <span style="color: #b13bff;">ANDA</span>
              </h1>
          ...
          <tr>
            <td class="body-pad" style="padding: 10px 30px 30px 30px; text-align: center;">
              ...
              <p
                ...
                Halo <strong style="color: #ffffff; font-weight: 600;">{{ $user->name ?? 'Pengguna' }}</strong>,
              </p>

              <p
                style="margin: 0 0 30px 0; font-size: 14px; color: #b5a9c2; line-height: 1.6; font-weight: 300; mso-line-height-rule: exactly;">
                Kami menerima permintaan untuk mengatur ulang kata sandi akun platform <strong style="color: #ffffff; font-weight: 600;">INCEPTION 2026</strong> Anda. Klik tombol di bawah ini untuk membuat kata sandi baru.
              </p>
              ...
              <!-- Action Button -->
              <!--[if mso]>
				<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ $url }}" style="height:46px;v-text-anchor:middle;width:240px;" arcsize="17%" strokecolor="#b13bff" fillcolor="#b13bff">
					<w:anchorlock/>
					<center style="color:#ffffff;font-family:Arial,sans-serif;font-size:13px;font-weight:bold;letter-spacing:1px;">RESET KATA SANDI</center>
				</v:roundrect>
			  <![endif]-->
              <!--[if !mso]><!-->
          ...
          <tr>
            <td style="padding: 0 30px 40px 30px; text-align: center;">
              <p
                style="margin: 0 0 10px 0; font-size: 12px; color: #726285; line-height: 1.5; mso-line-height-rule: exactly;">
                Jika Anda tidak meminta reset kata sandi, tidak ada tindakan lebih lanjut yang diperlukan. Kata sandi Anda akan tetap aman.
              </p>
              <p style="margin: 0; font-size: 13px; color: #726285; line-height: 1.5; mso-line-height-rule: exactly;">
                Jika Anda memiliki pertanyaan atau kendala, hubungi tim dukungan kami melalui Instagram <a
